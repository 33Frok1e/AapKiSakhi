...
const variantData = [
    {
        id: "1",
        type: "Diamond",
        description: "Code: KKI,Clarity:SI, Color:IJ, Cut RBC",
        purity: "null",
        UOM: "K",
        status: "Active",
        ratePerUnit: 125000,
    ...
    },
    {
        id: "3",
        type: "Diamond",
        description: "Code:Inv,Color-IJ, Clarity-SI, Cut - RBC",
        purity: "null",
        UOM: "K",
        status: "Active",
        ratePerUnit: 90000,
        ...
        <tr class="fade-in hover:bg-gray-50">
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <input class="row-checkbox w-5 h-5 text-primary-500 border-gray-300 rounded focus:ring-primary-500" type="checkbox" value="${variant.id}">
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${variant.id}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${variant.type}</td>
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <div class="flex flex-col">
                        <a href="#!" class="text-gray-900 font-semibold hover:text-primary-500 text-sm">${variant.description}</a>
                    </div>
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${variant.purity}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${variant.UOM}</td>
            <td class="px-6 py-4">
                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${variant.status === 'Active' ? 'badge-success' : 'badge-danger'}">
                    ${variant.status}
                </span>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${variant.ratePerUnit}</td>
            <td class="px-6 py-4">
...
function initializeSearch() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        filteredData = variantData.filter(product => 
