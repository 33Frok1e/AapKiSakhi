...
let currentPage = 0;
let pageSize = 10;
let filteredData = [...existingInvoiceData];
let sortColumn = null;
...
function renderTable() {
    ...
    tbody.innerHTML = pageData.map(items => `
        <tr class="fade-in hover:bg-gray-50">
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <input class="row-checkbox w-5 h-5 text-primary-500 border-gray-300 rounded focus:ring-primary-500" type="checkbox" value="${items.id}">
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${items.customer}</td>
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <div class="flex flex-col">
                        <a href="#!" class="text-gray-900 font-semibold hover:text-primary-500 text-sm">${items.invoiceNo}</a>
                    </div>
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${items.invoiceDate}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${items.invoiceAmount}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${items.cnNo}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${items.cnDate}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${items.cnAmount}</td>
            <td class="px-6 py-4">
...
function initializeSearch() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        filteredData = existingInvoiceData.filter(product => 
