...
const salesEntryData = [
    {
        ...
        customerName: "Rati Krishna",
        customerContact: 8117935016,
        itemCount: 1,
        qtyCount: 5,
        billAmount: 464757,
        receiveAmount: 420000
    },
    {
        invoiceNo: "INV00415",
        invoiceDate: "13-04-2024",
...
let currentPage = 0;
let pageSize = 10;
let filteredData = [...salesEntryData];
let sortColumn = null;
        ...
        <tr class="fade-in hover:bg-gray-50">
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <input class="row-checkbox w-5 h-5 text-primary-500 border-gray-300 rounded focus:ring-primary-500" type="checkbox" value="${sale.id}">
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.invoiceNo}</td>
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <div class="flex flex-col">
                        <a href="#!" class="text-gray-900 font-semibold hover:text-primary-500 text-sm">${sale.invoiceDate}</a>
                    </div>
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.entryDate}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.customerName}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.customerContact}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.itemCount}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.qtyCount}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.billAmount}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${sale.receiveAmount}</td>
            <td class="px-6 py-4">
...
function initializeSearch() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        filteredData = salesEntryData.filter(product => 
