...
// Purchase Approval Data
const purchaseApprovalData = [
    {
        documentNo: "AS2400016",
        entryDate: "30-03-2024",
        vendor: "BABU BHAI JEWELLERS 1",
        vendorDocument: "ASD23",
        vendorDocumentDate: "29-03-2024",
        itemCount: 1,
        qtyCount: 5,
        mrnNo: "MRN00163",
        mrnDate: "13-02-2024",
...
let currentPage = 0;
let pageSize = 10;
let filteredData = [...purchaseApprovalData];
let sortColumn = null;
        ...
        <tr class="fade-in hover:bg-gray-50">
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <input class="row-checkbox w-5 h-5 text-primary-500 border-gray-300 rounded focus:ring-primary-500" type="checkbox" value="${stock.id}">
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.documentNo}</td>
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <div class="flex flex-col">
                        <a href="#!" class="text-gray-900 font-semibold hover:text-primary-500 text-sm">${stock.entryDate}</a>
                    </div>
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.vendor}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.vendorDocument}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.vendorDocumentDate}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.itemCount}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.qtyCount}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.mrnNo}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${stock.mrnDate}</td>
            <td class="px-6 py-4">
...
function initializeSearch() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        filteredData = purchaseApprovalData.filter(product => 
