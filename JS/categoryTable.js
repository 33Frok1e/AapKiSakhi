...
const categoryData = [
    ...
    },
    {
        id: "3",
        code: "BS",
        description: "Diamond Ladies Bracelet",
        hsncode: "7102",
        status: "Active",
        itemCount: 117,
    },
    {
        id: "4",
        code: "CPS",
        description: "Colored Pendant Set",
        hsncode: "7102",
        status: "Active",
        itemCount: 21,
    },
    {
        id: "5",
        code: "CS",
        description: "Colored Pendant Necklace Set",
        hsncode: "710239",
        status: "Active",
        itemCount: 9,
    },
        ...
        <tr class="fade-in hover:bg-gray-50">
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <input class="row-checkbox w-5 h-5 text-primary-500 border-gray-300 rounded focus:ring-primary-500" type="checkbox" value="${category.id}">
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${category.code}</td>
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <div class="flex flex-col">
                        <a href="#!" class="text-gray-900 font-semibold hover:text-primary-500 text-sm">${category.description}</a>
                    </div>
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${category.hsncode}</td>
            <td class="px-6 py-4">
                <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${category.status === 'Active' ? 'badge-success' : 'badge-danger'}">
                    ${category.status}
                </span>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${category.itemCount}</td>
            <td class="px-6 py-4">
...
function initializeSearch() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        filteredData = categoryData.filter(product => 
