...
let currentPage = 0;
let pageSize = 10;
let filteredData = [...purchaseEntryData];
let sortColumn = null;
...
function renderTable() {
    ...
    tbody.innerHTML = pageData.map(purchase => `
        <tr class="fade-in hover:bg-gray-50">
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <input class="row-checkbox w-5 h-5 text-primary-500 border-gray-300 rounded focus:ring-primary-500" type="checkbox" value="${purchase.id}">
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${purchase.documentNo}</td>
            <td class="px-6 py-4">
                <div class="flex items-center">
                    <div class="flex flex-col">
                        <a href="#!" class="text-gray-900 font-semibold hover:text-primary-500 text-sm">${purchase.entryDate}</a>
                    </div>
                </div>
            </td>
            <td class="px-6 py-4 text-gray-900 text-sm">${purchase.vendor}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${purchase.vendorDocument}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${purchase.vendorDocumentDate}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${purchase.itemCount}</td>
            <td class="px-6 py-4 text-gray-900 text-sm">${purchase.qtyCount}</td>
            <td class="px-6 py-4">
...
function initializeSearch() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        filteredData = purchaseEntryData.filter(product => 
